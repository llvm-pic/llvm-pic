...
PICMidOperand::PICMidOperand(const PICMidSubtarget &sti, const MCExpr *val,
                             SMLoc s, SMLoc e): Kind(Immediate), start(s), end(e), imm(val), sti(sti) {

                             }

PICMidOperand::PICMidOperand(const PICMidSubtarget &sti, unsigned regNum,
                             SMLoc s, SMLoc e): Kind(Register), start(s), end(e), reg(regNum), sti(sti) {}

PICMidOperand::PICMidOperand(const PICMidSubtarget &sti, StringRef str,
                             SMLoc s): Kind(Token), start(s), tok(str), sti(sti) {}
